                ...
                if pixels_per_metric is not None:
                    ...
                    if real_length <= 300:
                        ...
                        if len(length_values) >= window_size:
                            ...
                            # Adjust peak and valley positions
                            peaks_x = [(peak[0] + size) / scale_factor for peak in peaks]
                            valleys_x = [(valley[0] + size) / scale_factor for valley in valleys]

                            # Plot smoothed length values
                            plt.plot(np.arange(0, len(smoothed_length_values)) / scale_factor,
                                     smoothed_length_values, color='red', label='Length', zorder=2)
                            ...
                            ax2 = ax1.twinx()
                            ax2.plot(np.arange(0, len(Force)) / scale_factor, Force, color='blue', label='Force',
                                     zorder=1)
                            ...
                            plt.legend(lines_1 + lines_2, labels_1 + labels_2, loc='upper left',
                                       bbox_to_anchor=(0.64, 0.995), prop={'size': 16})
                            ...
                            # Save smoothed length values to Excel
                            ...
                            print("Insufficient list length for filtering.")
